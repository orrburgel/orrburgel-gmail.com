        ...
        try:
            ...
            if self.path == "/favicon.ico":
                ...
                try:
                    ...
                    RESPONSEID = DATA["request"]["requset_id"]
...
def printer(HOST,URL,REQUEST,RESPONSEID,USERID,MAPID,SECERTKEY):
    ...
    try:
        ...
        CALLBACK = '{"status":"compiled","pdf_url":"'+HOST+"data/"+PDFFILE+".pdf"+'","request":{"requset_id":"'+USERID+'","user_id":"'+USERID+'","map_id":"'+MAPID+'"},"sign":"'+CALLBACKSIGN+'"}'
        print("-------------------")
        ...
        CALLBACK = '{"status":"'+sys.exc_info()[0]+'","request":{"requset_id":"'+USERID+'","user_id":"'+USERID+'","map_id":"'+MAPID+'"},"sign":"'+CALLBACKSIGN+'"}'
        print("-------------------")
