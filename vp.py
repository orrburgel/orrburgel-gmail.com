...
def printer(HOST,URL,REQUEST,REQUESTID,USERID,MAPID,SECERTKEY):
    ...
    try:
        ...
        CALLBACK = '{"status":"compiled","pdf_url":"'+HOST+"data/"+PDFFILE+".pdf"+'","request":{"request_id":"'+USERID+'","user_id":"'+USERID+'","map_id":"'+MAPID+'"},"sign":"'+CALLBACKSIGN+'"}'
        print("-------------------")
        ...
        CALLBACK = '{"status":"'+sys.exc_info()[0]+'","request":{"request_id":"'+USERID+'","user_id":"'+USERID+'","map_id":"'+MAPID+'"},"sign":"'+CALLBACKSIGN+'"}'
        print("-------------------")
